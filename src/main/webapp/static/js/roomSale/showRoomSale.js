    ...
    function loadPageRoomSale() {
        ...
        table.render({  //数据表格的数据渲染(此UI框架底层是进行异步加载)
            ...
            , cols: [[ //表头
                ...
                , {field: 'roomNum', title: '房间编号' , align: 'center', width: 140}
                ...
                , {field: 'days', title: '天数', align: 'center', width: 120, sort: true,style:'color: red;'}
                , {field: 'rentPrice', title: '住宿金额',align: 'center', width: 120, sort: true,style:'color: #2ec770;'}
                , {field: 'otherPrice', title: '其他消费',align: 'center', width: 120, sort: true,style:'color: #61c62e;'}
