...
<body >
	<div class="qiqiu1 qiqiu">
		<img src="http://q7dn1b5wf.bkt.clouddn.com/q2.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu2 qiqiu">
		<img src="http://q7dn1b5wf.bkt.clouddn.com/q3.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu3 qiqiu">
		<img src="http://q7dn1b5wf.bkt.clouddn.com/q4.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu4 qiqiu">
		<img src="http://q7dn1b5wf.bkt.clouddn.com/q5.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu5 qiqiu">
		<img src="http://q7dn1b5wf.bkt.clouddn.com/q6.png" />
		<div class="text">韦氏集团</div>
	</div>
	...
	<div class="login" style="height: 300px;">
		...
		<form class="layui-form" action="" lay-filter="example">
			...
			<div class="layui-form-item">
			    <input id="yzm" lay-verify="required|yzm" class="layui-input" placeholder="验证码(不区分大小写)"
