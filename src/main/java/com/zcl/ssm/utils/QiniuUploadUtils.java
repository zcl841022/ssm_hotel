...
public class QiniuUploadUtils {
    ...
    static String ACCESS_KEY = "fetntNlgYqN8WUbcQNx2l9HMVFHL0W94EAUIfXQ1";
    static String SECRET_KEY = "W-2E94ZHj2tGlBiNp1ZahaLw4hKREUwBSNpBdweL";
    //要上传的空间;对应到七牛上（自己建文件夹 注意设置公开）  
    static String bucketname = "zhangchenlong";
    //上传文件的路径 ;本地要上传文件路径  
  //  String FilePath = "C:\\Users\\Administrator\\Pictures\\good\\g1002\\g100201.jpg";
    //七牛云服务器存储空间的域名
    static String yuName = "http://q7dn1b5wf.bkt.clouddn.com/";
    //密钥配置  
